...
import { Component, AfterViewInit, OnDestroy, HostListener } from '@angular/core'; // Import HostListener
import { Router } from '@angular/router';
import { SideBar } from '../../side-bar/side-bar';
import { CommonModule } from '@angular/common'; // Import CommonModule for *ngFor
import { MatIconModule } from '@angular/material/icon'; // Import MatIconModule for the button icon
...
@Component({
  ...
  styleUrls: ['./home.css'],
  standalone: true,
  imports: [SideBar, CommonModule, MatIconModule], // Adicionar MatIconModule aqui
})
export class HomeComponent implements AfterViewInit, OnDestroy {
  currentIndex = 0;
  intervalId: any;
  showScrollToTopButton: boolean = false; // NOVO: Controla a visibilidade do botão
  ...
  timeline: TimelineItem[] = [
    {
      ...
      imagem: 'assets/img/timeline/1900-1910.jpg'
    },
    {
      periodo: '1910–1920',
      ...
      imagem: 'assets/img/timeline/1910-1920.jpg'
    },
    {
      periodo: '1920–1930',
      titulo: 'Consolidação',
      ...
      imagem: 'assets/img/timeline/1920-1930.jpg'
    },
    {
      periodo: '1930–1940',
      ...
      imagem: 'assets/img/timeline/1930-1940.jpg'
    },
    {
      periodo: '1940–1950',
      ...
      imagem: 'assets/img/timeline/1940-1950.jpg'
    },
    {
      periodo: '1950–1960',
      ...
      imagem: 'assets/img/timeline/1950-1960.jpg'
    },
    {
      periodo: '1960–1970',
      ...
      imagem: 'assets/img/timeline/1960-1970.jpg'
    },
    {
      periodo: '1970–1980',
      ...
      imagem: 'assets/img/timeline/1970-1980.jpg'
    },
    {
      periodo: '1980–1990',
      titulo: 'Globalização',
      ...
      imagem: 'assets/img/timeline/1980-1990.jpg'
    },
    {
      periodo: '1990–2000',
      ...
      imagem: 'assets/img/timeline/1990-2000.jpg'
    },
    {
      periodo: '2000–2010',
      ...
      imagem: 'assets/img/timeline/2000-2010.jpg'
    },
    {
      periodo: '2010–2020',
      ...
      imagem: 'assets/img/timeline/2010-2020.jpg'
    },
    {
      ...
      imagem: 'assets/img/timeline/2020-presente.jpg'
    }
  ];
  ...
  // NOVO: Listener para o evento de scroll da janela
  @HostListener('window:scroll', [])
  onWindowScroll() {
    // Mostra o botão se o scroll vertical for maior que 200px
    this.showScrollToTopButton = (window.scrollY > 200);
  }

  // NOVO: Método para rolar a página para o topo
  scrollToTop(): void {
